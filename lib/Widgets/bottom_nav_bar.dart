    ...
    return CurvedNavigationBar(
      ...
      index: indexNum,
        ...
        items:[
          ...
          Icon(Icons.add, size: width * 0.060, color: Colors.black,),
          Icon(Icons.person_pin, size: width * 0.060, color: Colors.black,),
          Icon(Icons.exit_to_app, size: width * 0.060, color: Colors.black,)
        ] ,
      onTap: (index){
        if(index == 0){
